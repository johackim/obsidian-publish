...
export default () => {
    ...
    return (
        <div className={`site-body-left-column-site-theme-toggle ${theme === 'dark' ? 'is-dark' : ''}`}>
    ...
    ntColor"
                    ...
                    className="svg-icon lucide-moon"
                >
                    <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" />
                </svg>
            </span>
            <div className={`checkbox-container ${theme === 'dark' ? 'is-enabled' : ''}`} onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} /> {/* eslint-disable-line */}
            {theme === 'dark' ? (
                <span className="option mod-dark">
